...
`User`의 메소드와 속성들을 동일하게 가지는데
`has_permissions_for()`를 호출하면 `permissions` dictionary를 체크하지 않는다.
...
# min()으로 self.red + other.red 와 255 중 더 작은 수를 반환
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQxODcxNTc2MSw4NTA1NTQ1NjAsLTQxOD
cxNTc2MV19
-->